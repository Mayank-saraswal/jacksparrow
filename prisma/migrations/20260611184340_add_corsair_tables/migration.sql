...
-- CreateIndex
CREATE INDEX "corsair_accounts_tenant_id_integration_id_idx" ON "corsair_accounts"("tenant_id", "integration_id");

-- CreateIndex
CREATE INDEX "corsair_entities_account_id_idx" ON "corsair_entities"("account_id");

-- CreateIndex
CREATE INDEX "corsair_entities_account_id_entity_type_idx" ON "corsair_entities"("account_id", "entity_type");
